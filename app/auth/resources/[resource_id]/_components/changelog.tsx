...
export default function ResourceChangelog({ versions, currentDocumentName }: { versions: Document[], currentDocumentName: any }) {
    return (
        <div className="mt-5">
